...
$table_config['cell_tabs_arr'] = Array ('main' => 'Main', 'adv' => 'Advanced', 'translate' => 'Translate', 'chat' => 'Chat');


$i++;
$adv_rel_inputs[$i]['name'] = 'translate';
$adv_rel_inputs[$i]['input_type'] = 'translate_form';
$adv_rel_inputs[$i]['text'] = 'Translate';
$adv_rel_inputs[$i]['help'] = '';
$adv_rel_inputs[$i]['table'] = 'it_tree_plans_translate';
$adv_rel_inputs[$i]['id_column'] = 'id';
$adv_rel_inputs[$i]['lang_alias_column'] = 'lang_alias';
